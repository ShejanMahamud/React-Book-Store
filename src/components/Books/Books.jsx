    ...
    return (
        <div className='flex items-center gap-12 w-full h-full lg:p-5 p-10 lg:flex-row flex-col my-5'>
            ...
            <div className='w-full h-full *:mb-5'>
                ...
                <button className='bg-[#FFCE1A] px-4 py-2 rounded-lg text-white font-medium text-sm flex items-center gap-2' onClick={()=>{getBookDetails(bookTitle,discountedPrice ? discountedPrice : originalPrice,bookStatus,book)}}>
